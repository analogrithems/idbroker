...
<title><?php echo h($title_for_layout) ?></title>
  ...
  <title>idBroker - LDAP Browser</title>
        ...
        <?php echo $this->Html->css('/idbroker/js/jqueryUI/css/smoothness/jquery-ui-1.8.14.custom')."\n"; ?>
...
<body>
<div id="container">
                <div id="MyAccount"><?php echo $this->Html->link("MyAccount", '/idbroker/people/MyAccount', array('class'=>'button')); ?></div>
                <div id="Logout"><?php echo $this->Html->link("Logout", '/idbroker/ldap_auths/logout', array('class'=>'button'));?></div>
		...
		<div id="popupMenu"></div>
                ...
                <div id="footer">
                        <?php
                                echo $this->Html->link('IDBroker', 'http://analogrithems.com/rant/idbroker', array('target'=>'_blank'), null, false );
                        ?>
                </div>
